...
var ui = {
    ...
    head:{
        view:"toolbar", cols:[
            { view:"label", label: "Adicione os arquivos para transmissão(máximo 20 arquivos)" },
            //{ view:"label", label: "Somente extensões ZIP, WXML, MDT, DCM, PDF, OIT e EEG são permitidos" },
                        ...
                        view: "form", width: 1000, maxHeight: 500, elements: [
                        {
                            ...
                            on: {
                                'onBeforeFileAdd': function(item){
                                    ...
                                    return true; //(type == "zip" || type == "oit" || type == "dcm" || type == "eeg" || type == "wxml" || type == "pdf" || type == "mdt");
                                },
