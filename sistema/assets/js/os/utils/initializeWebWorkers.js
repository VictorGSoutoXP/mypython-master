...
if (UrlExists('./cornerstoneWADOImageLoaderWebWorker.min.js')) {
  webWorkerUrl = './cornerstoneWADOImageLoaderWebWorker.min.js';
}

if (UrlExists('./cornerstoneWADOImageLoaderCodecs.js')) {
  codecsUrl = './cornerstoneWADOImageLoaderCodecs.js';
}
