...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Digite mais " + n + " letra" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Remova " + n + " letra" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Você pode digitar " + limit + " item" + (limit == 1 ? "" : "s"); },
