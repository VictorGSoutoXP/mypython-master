...
private $defaultDiacriticsRemovalMap = array(
        array(
        'base'=>"A",
    ...
    function noDiacritics($str){
        ...
        $flags = "um";
        for ($i = 0; $i < sizeof($this->defaultDiacriticsRemovalMap); $i++)
            $str = preg_replace($this->defaultDiacriticsRemovalMap[$i]['letters'].$flags, $this->defaultDiacriticsRemovalMap[$i]['base'], $str);
