...
$this->debugfonts = true; //false;	// Checks and reports on errors when parsing TTF files - adds significantly to processing time
$this->showImageErrors = true; //false;
$this->table_error_report = true; // false;		// Die and report error if table is too wide to contain whole words
