  ...
  <form class="form-inline search-top">
	...
	<div class="span10 fix-width">
		<span style="color:red">
			...
			<ul>
				<li>Prezado cliente, voltamos ao sistema antigo (ESTE QUE VOCÊ ESTÁ AGORA). Aqui você encontrará os exames e laudos que enviou naquele link temporário. Qualquer problema, favor procurar o suporte técnico.</li>
