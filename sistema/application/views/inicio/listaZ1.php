<?php echo $this->load->view('layouts/menu',false,true,false); ?><?php echo "<meta HTTP-EQUIV='refresh' CONTENT='600;URL=http://damatelemedicina.com.br/sistema/inicio/lista'>"; ?>
