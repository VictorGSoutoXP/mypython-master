...
<div class="tab-content">
  <div class="tab-pane active" id="dados-cliente">
	  ...
	  <div class="row">
		...
		<div class="row">
			<div class="span8">
				<label for="mensagem_exames">Mensagem para Laudos</label>
				<textarea id="mensagem_laudos" name="mensagem_laudos" cols="30" rows="4" class="span8"><?php echo $usuario['mensagem_laudos']?></textarea>
			</div>
		</div>
