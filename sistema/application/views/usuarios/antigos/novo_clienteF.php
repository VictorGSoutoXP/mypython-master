...
<div class="tab-content">
  <div class="tab-pane active" id="dados-cliente">
	  ...
	  <div class="row">
		  <div class="span5">
			  <label class="checkbox"> <input type="checkbox" value="1" <?php echo $usuario['emergencias'] == '1' ? 'checked' : '' ?> id="emergencias" name="emergencias"> Desativar Emergências
			  </label>
		  </div>
	  </div>
  ...
  <div class="tab-pane" id="exames-cliente">
    	...
    	<div class="exame-row deactive">
        	...
        	<div class="row header">
        		...
        		<div class="span6 sub-tipos-container">
            		<div class="row">
        	...
        	<div class="row">
        		...
        		<div class="span1 text-center"><input class="active-deactive" type="checkbox" name="exames_clientes[<?php echo $tipo['id']?>][active]" value="1" <?php echo $exame ? "checked" : ""?> /></div>
