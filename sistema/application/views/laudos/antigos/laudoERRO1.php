					...
					<table class="table mt20" width="100%">
						<tr>
                            ...
                            <td width="30%" valign="top">
								<?php 
									...
									$label_nascimento = (strpos("2|7|8", $exame['exame_id']) !== false) ? "IDADE:" : "NASC:";
								?>
								<strong><?php echo $label_nascimento; ?></strong> <?php echo $nascimento; ?>
							</td>
						...
						<tr>
							...
							<td valign="top" colspan="2">
								<?php if( $exame['paciente']['funcao'] ) {?>
									<strong>&nbsp;FUNÇÃO: </strong> <?php echo $exame['paciente']['funcao']; ?>
								<?php }?>
							</td>
							<td valign="top"></td>
						</tr>
			...
			<div class="mt20">
				<div class="box">
					...
					<div style="width: 90%;margin: 0 auto;">
						<img src="<?php echo site_url('assets/img/dama') . '/signer.jpeg'; ?>" />
						<span style="font-family: 'Courier New', Monospace">
							Protocolo:<span color="red"><?php echo $CERT["protocolo"]; ?></span>
						</span>
						<!--
