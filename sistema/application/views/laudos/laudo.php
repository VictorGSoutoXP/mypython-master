				...
				<td colspan="6">
					<?php
						if(!$exame['motivos']) {
							...
							if($exame['exame_id'] == '1' && $exame['dados_ecg']) echo $exame['dados_ecg'];
							else  echo '<span style="font-size:10px;">' . $exame['modelo_content'] . '</span>';
			...
			<tr>
				<td colspan="6">
					<span style="color:red;">
						<?php echo $exame["cliente"]["mensagem_laudos"]; ?>
					</span>
				</td>
			</tr>
