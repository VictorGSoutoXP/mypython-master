        ...
        <div>
            <div class="oit-box">
                ...
                <div>
                    ...
                    <span class="oit-label">Dt.Nasc.:</span> <span class="oit-text"><?php echo $exame['paciente']['nascimento'] . '(' . $exame['paciente']['idade'] . ')' ?></span> Sexo: <span class="oit-text"><?php echo $exame['paciente']['sexo']; ?></span><br />
                    <span class="oit-label">RG:</span> <span class="oit-text"><?php echo $exame['paciente']['rg']?></span>
                </div>
            </div>
            <div class="oit-box">
                <div style="float: left; width: 40%;">
                    <span class="oit-label">Data do Exame:</span> <span class="oit-text"><?php echo date('d/m/Y', strtotime($exame['exame_date']))?></span><br />
                ...
                <div>
                    <span class="oit-label">Data da Leitura:</span> <span class="oit-text"><?php echo date('d/m/Y', strtotime($exame['laudo_date']))?></span><br />
            ...
            <div class="oit-box" style="height: 110px">
                <div style="float: left;width: 270px;padding-right: 20px;">
                    <div>
