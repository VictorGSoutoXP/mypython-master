...
<title>Sistema de Laudo Online - <?php echo strtoupper($empresa); ?></title>
								...
								<li class="dropdown" style="white-space: nowrap;">
									...
									<ul class="dropdown-menu">
										<?php if(UserSession::isMedico() || UserSession::isAdmin()){?>
										    <li><a href="<?php 
												echo UserSession::isMedico() ? site_url("usuarios/perfil_medico") : site_url("usuarios/perfil") ?>">Editar Perfil</a></li>
											<li class="divider"></li>
