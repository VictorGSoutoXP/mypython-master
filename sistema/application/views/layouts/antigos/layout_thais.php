...
<title>Sistema de Laudo Online - <?php echo logo(true);?></title>
			...
			<div class="navbar navbar">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="<?php echo site_url("/")?>"><?php echo logo();?></a>
						<div class="nav-collapse collapse">
							...
							<?php if(UserSession::isAdmin()){?>
							    <li class="dropdown">
							    	<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-user">Usuários</a>
						    ...
						    <?php }?>
								<li class="dropdown" style="white-space: nowrap;">
									<a title="Exames aguardando laudo" href="<?php echo site_url("inicio/expirando");?>" class="badge-exames-top"><span class="badge badge-important"><?php echo get_count_waiting()?></span></a>
