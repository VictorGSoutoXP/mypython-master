<div class="row">
		...
		<div class="span2">
			...
			<input type="text" id="paciente[sexo]" class="span2 required" name="paciente[sexo] required" value="<?php echo $paciente['sexo'] ? ($paciente['sexo'] == "M" ? "Masculino" : "Feminino") : ""?>" <?php echo $paciente['readonly'] ? "disabled" : ""?>/>
			<?php } else {?>
...
<div class="row">
		...
		<div class="span2">
			<label for="paciente[funcao]">Função</label>
			<input type="text" id="paciente[funcao]" class="span3" name="paciente[funcao]" value="<?php echo $paciente['funcao']?>" <?php echo $paciente['readonly'] ? "disabled" : ""?> />
		</div>
</div>
