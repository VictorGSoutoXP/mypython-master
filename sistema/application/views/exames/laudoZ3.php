			...
			<fieldset>
				...
				<?php if ($pdf) { ?>
						<div style="float:right;">
							<label for="pagina_pdf_laudo">Pág. PDF</label> <input type="number" name="pagina_pdf_laudo" id="pagina_pdf_laudo" data-toggle="tooltip" title="Página do PDF a ser exibida no laudo." class="span1 required" name="limite_horas" value="<?php echo $exame['pagina_pdf_laudo'] ? $usuario['pagina_pdf_laudo'] : 1; ?>" />
						</div>
				<?php } ?>
