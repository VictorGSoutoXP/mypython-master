...
<div class="row">
	<form action="<?php echo site_url("exames/laudo");?>" method="post" name="enviaLaudoHolter" id="enviaLaudoHolter" enctype="multipart/form-data">
		...
		<div class="span12">
			...
			<fieldset>
				...
				<div id="laudo_info_container" class="well well-small" style="<?php echo ($exame['status'] == 2 || $exame['exame_id'] == 9 || $exame['exame_id'] == 10) ? "display: none;" : ""?>">
				...
				<div id="laudo_holter" style="<?php echo ($exame['exame_id'] != 10) ? "display: none;" : ""?>">
					
					<legend><strong class="text-error">Arquivo do Laudo</strong></legend>

					<div class="span7">
						<label>Arquivo de Laudo(PDF)</label>
						<div>
							<span class="btn btn-file">
								<span>Selecione o arquivo</span>
								<input 
									id="arquivo_laudo_holter" 
									type="file" 
									name="arquivo_laudo_holter" 
									accept="application/pdf" required />
							</span><br />
							<span id="fileupload-holter-preview" class="fileupload-preview" style="color: red; font-size: 12px"></span>
						</div>
					</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#arquivo_laudo_holter").change(function() {
			var input = document.getElementById('arquivo_laudo_holter');
			var file = input.files[0];
			$('#fileupload-holter-preview').text(file.name);
