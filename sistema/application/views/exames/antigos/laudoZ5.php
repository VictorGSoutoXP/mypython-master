					...
					<div class="row">
						<div class="span4">
							...
							<?php if ($exame['exame_id'] == 10) { ?> 
								<select name="laudo_modelo" id="laudo_modelo" class="select-box-auto-width span4 required" readonly value="-1">
						...
						<div class="span7">
							...
							<span class="btn btn-file">
								...
								<?php if ($exame['exame_id'] == 10) { ?>
									...
									<input id="arquivo_laudo_holter" type="file" 
										name="arquivo_laudo_holter" accept=".pdf" required />
