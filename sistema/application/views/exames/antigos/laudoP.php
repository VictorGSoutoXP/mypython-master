			...
			<fieldset>
				...
				<?php if($exame['arquivo_imagem']){ ?>
					...
					<fieldset>
						...
						<?php if ( $posA === false ) { ?>
							  <canvas onClick="rotate(0)" title="CLIQUE PARA GIRAR!" style="display:none;" id="canvas0"></canvas>
							  <img title="CLIQUE PARA GIRAR!" onClick="rotate(0)" id="image0" onClick="rotate(0)" src="<?php echo site_url("uploads/dama/exames/" . $exame['arquivo_imagem'])?>" alt="Arquivo de imagem">
						<?php } else { ?>
							<?php for ($i=0; $i < $arquivos;$i++) { ?>
									<canvas title="CLIQUE PARA GIRAR!" onClick="rotate(<?php echo $i;?>)" id="canvas<?php echo $i;?>"></canvas>
