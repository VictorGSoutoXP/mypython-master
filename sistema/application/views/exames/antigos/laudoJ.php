		...
		<div class="span12">
			...
			<fieldset>
				...
				<?php if($exame['arquivo_imagem']){?> 
					<legend><strong class="text-error">Exame em Imagem</strong></legend>
				...
				<div id="form-oit-container" <?php echo $exame['exame_id'] == 9 ? '': 'style="display:none"' ?> >
					...
					<div class="row"> 
						<div class="span3">
							...
							<input type="radio"  <?php echo $exame['status'] == 2 ? 'disabled="disabled"' : "" ?>  name="exame_oit[normal]" value="S"
								<?php echo $exame_oit['normal'] == 'S' ? 'checked="checked"' : ''?>> SIM 
							<input type="radio"  <?php echo $exame['status'] == 2 ? 'disabled="disabled"' : "" ?>  name="exame_oit[normal]" value="N" 
...
<script>
	...
	function changeSessao2(value){
		...
		if (value == 'N') $("#sessao2").hide();
	}

	function changeSessao3(value){
		if (value == 'S') $("#sessao3").show();
		if (value == 'N') $("#sessao3").hide();
	}

	function changeSessao4(value){
		if (value == 'S') $("#sessao4").show();
		if (value == 'N') $("#sessao4").hide();
	}

	$(document).ready(function(){

		console.log('>>', $("#anormalidade_parenquima").val());
