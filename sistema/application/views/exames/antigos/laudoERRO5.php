			...
			<fieldset>
				...
				<?php if($exame['arquivo_imagem']){ ?>
					...
					<fieldset>
						...
						<?php if ( $posA === false ) { ?>
							  <canvas title="CLIQUE PARA GIRAR!" onClick="rotate(0)" id="canvas0"></canvas>
							  <img style="display: none;" id="image0" onClick="rotate(0)" src="<?php echo site_url("uploads/dama/exames/" . $exame['arquivo_imagem'])?>" alt="Arquivo de imagem">
						<?php } else { ?>
