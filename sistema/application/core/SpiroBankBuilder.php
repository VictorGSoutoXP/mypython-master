...
abstract class AbstractSpiroBankBuilder implements SpiroBank {
...
class SpiroBankBase extends AbstractSpiroBankBuilder {
...
class SpiroBankBuilder {

	var $builder;

	function __construct() {
		$this->builder[] = new SpiroBankBase();
	}
